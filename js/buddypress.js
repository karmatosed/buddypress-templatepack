...
/*
* Replace JS embed scripts for autofocus
* Test for browser support for 'autofocus'
* Add .focus if not supported via class name 'add-focus'.
* Input elements require class name 'add-focus' & html5 attr 'autofocus'
*/
